...
console.log("exampleGroups", exampleGroups);
...
console.log("exampleInitiatives", exampleInitiatives);
...
console.log("exampleReleases", exampleReleases);
...
console.log("exampleFeatures", exampleFeatures);
...
console.log("exampleMarkers", exampleMarkers);
export default function GanttExample() {
    ...
    console.log("sortedGroupedFeatures", sortedGroupedFeatures);
