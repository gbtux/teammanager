...
interface GanttSidebarHeaderProps {
    title?: string;
    durationLabel?: string;
}
export const GanttSidebarHeader: FC<GanttSidebarHeaderProps> = ({title = "Issues", durationLabel = "Duration"}) => (
  <div
...
export const GanttSidebar: FC<GanttSidebarProps> = ({
  ...
  >
    <GanttSidebarHeader title={title} durationLabel={durationLabel} />
